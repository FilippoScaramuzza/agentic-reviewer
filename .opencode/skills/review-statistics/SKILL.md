...
description: >
  Evaluates statistical methods, analysis rigor, data presentation, and
  reproducibility of quantitative findings in an academic paper. Used
  by the statistics-reviewer agent.
license: MIT
compatibility: opencode
metadata:
  audience: statistics-reviewer
  phase: review
  category: statistics
---
